...
// CONCATENATED MODULE: ./src/components/DateCountdown.vue?vue&type=template&id=149e837a&
...
/* harmony default export */ var DateCountdownvue_type_script_lang_js_ = ({
  ...
  created: function created() {
    this.now = new Date();
    var r = window.moment.duration(Date.parse(this.until) - this.now);
  ...
  methods: {
    refreshEverySecond: function refreshEverySecond() {
      ...
      var interval = setInterval(function () {
        _this.now = new Date();
        var r = window.moment.duration(Date.parse(_this.until) - _this.now);
        if (r <= 0) _this.$emit('finished');
        _this.remaining = {
          total: r,
          days: r.days(),
          hours: r.hours(),
